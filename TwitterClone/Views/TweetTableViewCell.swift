...
class TweetTableViewCell: UITableViewCell {
    ...
    private let tweetTextContentLabel : UILabel = {
        let label = UILabel()
        label.text = "Am I filling your timeline with my repetitive tweets? Tell me honestly, or I will ban you"
    ...
    private func configureConstraints(){
        ...
        let tweetTextContentLabelCopnstraints = [
        ...
        NSLayoutConstraint.activate(tweetTextContentLabelCopnstraints)
