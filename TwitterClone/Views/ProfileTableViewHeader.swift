...
//  TwitterClone
//
//  Created by ROHIT DAS on 16/02/23.
//
...
class ProfileTableViewHeader: UIView {
    ...
    private let userBioLabel : UILabel = {
       let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Founder of Twitter | Love tweeting unfunny things whole day "
    ...
    private func configureConstraints(){
        ...
        let followingCountLabelConstraints = [
            ...
            followersTextLabel.topAnchor.constraint(equalTo: joinedDateLabel.bottomAnchor,constant: 10)
